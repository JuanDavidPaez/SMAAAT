...
public final class Const {
    ...
    public static class NodeNames {
        ...
        public static final String NoneBulletsNode = "NoneBulletsNode";
        public static final String FloorNode = "FloorNode";
        public static final String CharacterNode = "CharacterNode";
        public static final String BulletsNode = "BulletsNode";
    }

    protected static class FloorFiles {

        public static final String BigFloor = "Smaaat/floor.smaaat";
